...
export const FeedbackModal = ({ closeModal }) => {
	...
	return (
		<div>
			<div
				...
				aria-hidden='true'
			>
				<div className='w-1/3 mx-auto overflow-y-auto bg-compBg rounded-lg shadow-lg modal-container md:max-w-11/12  '>
					<div className='px-3 py-3 text-left modal-content'>
						...
						<div className='flex w-full pt-2 mt-2'>
							...
							<div>
								<button
									className='w-40 p-3 pl-2 font-bold text-left bg-compBg rounded-full text-modalButton'
