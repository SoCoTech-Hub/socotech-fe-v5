...
const index = ({
	...
	useEffect(() => {
		const mergedArray = socialLoves.concat(articleLikeLoves)
	...
	return (
		<>
			...
			<div className='w-full p-3 rounded-lg bg-compBg shadow-menu'>
				<div className=''>
					<div
						className='pt-2 pb-1 pl-6 pr-6 text-lg text-textColor mobile:p-1'
					>
						{title}
					</div>
					<div
						className='px-6 text-textColor mobile:p-1'>
					...
					<div className='w-full'>
						...
						<div className='pt-3'>
							<div
								className='flex-shrink px-6 text-textColor mobile:p-1'
							>
