...
const tou = () => {
	...
	return (
		<>
			...
			<div className='overflow-scroll bg-appBg desktop:h-full laptop:h-full mobile:h-full no-scrolly text-textColor desktop:p-4 laptop:p-4 mobile:p-1'>
				<LogoOverlay />
				<div className='p-4 rounded-lg bg-compBg desktop:mt-28 laptop:mt-20 mobile:mt-12 drop-shadow-md no-scrolly '>
					<div className='flex items-center justify-between mb-2'>
						<div className='text-xl text-textColor'>Terms of Use</div>
					...
					<p>
						...
						thereof, must include the following copyright notice: ©TOPIC. <br />
						<br />
