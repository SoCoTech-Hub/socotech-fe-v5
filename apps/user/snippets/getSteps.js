const steps = [
	...
	//   content: (
	//     <p>
	//       Plan your week by having a look at upcoming events. You can expect to
	//       see information about events like live lessons, upcoming tests and more.
	//     </p>
	//   ),
	// },
	{
		...
		content: (
			// <p>
			//   You can use this button to log out, or if you are working at night, you
			//   can turn on dark mode for easier viewing.
			// </p>
			<p>
	...
	// {
	//   selector: '[data-tour="liveLesson"]',
	//   content: (
	//     <p>
	//       Access regular in-depth lessons presented live by subject experts here.
	//       Remember to visit the events section to see when live lessons are
	//       scheduled for.
	//     </p>
	//   ),
	// },
	{
		...
		content: (
			<p>
				Get a quick overview of your progress and results when you click
				here.You can also add your own status updates here.
			</p>
		)
	},
	{
	...
	},
	{
		...
		content: (
			<p>
				You can visit this section of the platform to review undegraduate
	...
	// {
	// 	selector: '[data-tour="supportIcon"]',
	// 	content: (
	// 		<p>
	// 			If you need any technical or educational support, you can click here to
	// 			complete a ticket. You can choose the correct department that you need
	// 			help from and include a screenshot. An agent will reach out to you with
	...
	},
	{
		...
		content: (
			<p>
				...
				need to by heading to the 'Profile'Icon. Click anywhere to close this
				tour.
			</p>
		)
	}
