		...
		<>
			...
			>
				...
				<div className='flex'>
					...
					<div
						className='gap-32 pt-2.5 overflow-scroll desktop:w-8/12 laptop:w-8/12 mobile:w-full desktop:mx-8 laptop:mx-8 mobile:mx-1 justify-evenly h-content no-scrolly'
						id='container'
					>
						<main className='main'>
							<div
