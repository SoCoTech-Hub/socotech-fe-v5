export const KnowledgeBaseIcon = (props) => (
  <svg
    ...
    {...props}
  >
    <g id="KnowledgeBase_1-2" data-name="KnowledgeBase 1">
      <g>
        <circle
