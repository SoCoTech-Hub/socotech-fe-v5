       ...
       {/* Settings Dropdown */}
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end">
                ...
                <DropdownMenuItem onClick={() => handleLinkClick("/profile")}>Profile</DropdownMenuItem>
                <DropdownMenuItem onClick={() => handleLinkClick("/account")}>Account</DropdownMenuItem>
                <DropdownMenuItem onClick={() => handleLinkClick("/preferences")}>Preferences</DropdownMenuItem>
                <DropdownMenuSeparator />
                <DropdownMenuItem onClick={() => handleLinkClick("/logout")}>Log out</DropdownMenuItem>
              </DropdownMenuContent>
            </DropdownMenu>
       {/* User Avatar Dropdown */}
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end">
                ...
                <DropdownMenuSeparator />
                <DropdownMenuItem onClick={() => handleLinkClick("/profile")}>Profile</DropdownMenuItem>
                <DropdownMenuItem onClick={() => handleLinkClick("/dashboard")}>Dashboard</DropdownMenuItem>
                <DropdownMenuSeparator />
                <DropdownMenuItem onClick={() => handleLinkClick("/logout")}>Log out</DropdownMenuItem>
              </DropdownMenuContent>
            </DropdownMenu>
                ...
                <div className="flex flex-col flex-grow mt-6 space-y-4 overflow-y-auto">
                  ...
                  <div className="space-y-2">
                    {expandableItems.map((item) => (
                      <ExpandableItem key={item.name} item={item} activeLink={activeLink} setActiveLink={handleLinkClick} />
                    ))}
                  </div>
                </div>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end">
                        ...
                        <DropdownMenuSeparator />
                        <DropdownMenuItem onClick={() => handleLinkClick("/profile")}>Profile</DropdownMenuItem>
                        <DropdownMenuItem onClick={() => handleLinkClick("/settings")}>Settings</DropdownMenuItem>
                        <DropdownMenuItem onClick={() => handleLinkClick("/notifications")}>Notifications</DropdownMenuItem>
                        <DropdownMenuSeparator />
                        <DropdownMenuItem onClick={() => handleLinkClick("/logout")}>Log out</DropdownMenuItem>
                      </DropdownMenuContent>
                    </DropdownMenu>
