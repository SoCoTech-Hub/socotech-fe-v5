...
const meta: Meta<typeof ReportListing> = {
  ...
  argTypes: {
    id: {
      control: { type: "text" },
      description: "Unique identifier for the report listing.",
    },
    ...
    setSelection: {
      ...
      description: "Handler called when a report is selected.",
    },
    bgColor: {
      control: { type: "text" },
    ...
    iconSvg: {
      control: { type: "text" },
      description: "SVG icon for the report listing.",
    },
  },
};
...
export const Normal: Story = {
  ...
  args: {
    ...
    courseTitle: "Software Engineering Report",
    courseCompanyName: "Tech Corp",
    courseDescription: "A report opportunity for aspiring software engineers.",
    setSelection: (id) => console.log("Selected report:", id),
    bgColor: "bg-blue-500",
    iconSvg: "",
  },
};
...
export const WithIconSvg: Story = {
  ...
  args: {
    id: "2",
    courseTitle: "Data Science Report",
    courseCompanyName: "Data Insights Inc.",
    courseDescription: "Report for students pursuing data science.",
    setSelection: (id) => console.log("Selected report:", id),
    iconSvg:
...
export const NoImageOrIcon: Story = {
  ...
  args: {
    id: "3",
    courseTitle: "Business Management Report",
