...
const Template: StoryFn<ArticleProps> = (args) => <Article {...args} />;
...
DefaultArticle.args = {
  article: {
    ...
    content: "<p>Space, the final frontier. These are the voyages...</p>",
  ...
  publisher: {
    ...
    about:
      "Jane Doe is an acclaimed astrophysicist with years of experience studying the cosmos.",
    links: [
      {
