	...
	return (
		<>
			...
			<div className='flex items-center justify-between align-middle'>
				<p className='py-2 ml-1 text-2xl font-bold text-themeColorMain'>
					Log Ticket
				</p>
			</div>
					...
					<div className='mt-2'>
						...
						<div className='w-full pl-2'>
							<input
								...
								className='w-full px-2 py-3 border-2 border-gray-300 rounded-lg bg-compBg desktop:mb-4 laptop:mb-4 mobile:mt-1 focus:outline-none text-textColor'
