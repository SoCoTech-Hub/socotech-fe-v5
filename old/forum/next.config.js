		...
		return [
			{
				...
				headers: [
					...
					},
					{
						...
						value: `default-src 'self' ${process.env.NEXT_PUBLIC_DOMAIN} ${process.env.NEXT_PUBLIC_MAIN_URL} ${process.env.NEXT_PUBLIC_BUCKET} 'unsafe-inline'; connect-src *; img-src *; script-src-elem * 'unsafe-inline'; worker-src *;frame-src *`
						// {
						//   key: "Content-Security-Policy",
