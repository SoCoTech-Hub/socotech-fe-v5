		...
		<>
			...
			>
				...
				<div className='flex'>
					...
					<div
						className='pt-2.5 mobile:pt-4 mobile:pb-14 overflow-scroll desktop:w-8/12 laptop:w-8/12 mobile:w-full mobile:mx-1 desktop:mx-8 laptop:mx-8 justify-evenly h-content no-scrolly'
						id='container'
					>
						<main className='main'>
							<div
					...
					<div className='w-2/12 h-full pl-0 pr-3 space-y-2 pt-2.5 mobile:hidden desktop:block'>
						<div
							className=''
