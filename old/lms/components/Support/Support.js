			...
			<form className='w-full'>
					...
					<div className='desktop:mt-2 laptop:mt-2'>
						...
						<div className='w-full pl-2'>
							<DefaultSelectNew
								...
								value={topic}
								className='p-2 font-bold border-2 border-gray-300 rounded-lg bg-compBg text-textColor'
							/>
						</div>
					</div>
				</div>
				...
				<div className='w-full'>
					<div className='w-full pl-2'>
						<label
							htmlFor='phone'
							className='mb-2 font-bold text-textColor'
						>
							Ticket Message
						</label>
					</div>
					<div className='w-full pl-2'>
						<textarea
							className='block w-full p-2 border-2 border-gray-300 border-solid rounded-lg resize-none bg-compBg text-textColor focus:outline-none'
							rows='4'
							placeholder='Start typing here'
							value={message}
