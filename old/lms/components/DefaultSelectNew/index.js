...
export default function DefaultSelectNew({
	...
	return (
		<div className='relative desktop:my-2 laptop:my-2 font-bold mobile:my-1'>
			<div className={className}>
				<input
					id={id}
					type='text'
					className='w-full text-textColor bg-compBg border-2 border-white cursor-pointer p-3 rounded-lg'
