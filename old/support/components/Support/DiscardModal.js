...
export const DiscardModal = ({ discardModal, closeModal }) => (
	<div
		...
		aria-hidden='true'
	>
		<div className='w-1/6 mx-auto overflow-y-auto bg-compBg rounded-lg shadow-lg modal-container md:max-w-11/12  '>
			<div className='px-3 py-3 text-left modal-content'>
				...
				<div className='mt-3 ml-1 mr-1 text-textColor '>
					If you discard, you wont share any feedback with us.
				</div>
