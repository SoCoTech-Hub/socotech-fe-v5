		...
		<>
			<div className='overflow-hidden appFullHeight row g-0 no-scrolly bg-appBg'>
				...
				<div className='flex mobile:pb-6 mobile:bg-appBg'>
					...
					<div
						className='pt-2.5 mobile:pt-3 overflow-scroll desktop:w-8/12 laptop:w-8/12 mobile:w-full mobile:mx-1 desktop:mx-8 laptop:mx-8 justify-evenly h-content no-scrolly'
						id='container'
					>
						<main className='main'>
							<div
